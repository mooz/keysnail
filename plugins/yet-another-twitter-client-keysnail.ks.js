...
var twitterClient = (
    function () {
        ...
        Crawler.prototype = {
            ...
            get lastID() util.getUnicharPref(this.lastKey),
            set lastID(id) util.setUnicharPref(this.lastKey, id),
        ...
        function setLastID(crawler, updateStatusbar) {
